...
public class ReceiveMsgServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String msg = request.getParameter("msg");  // "msg"는 name 값 , msg 는 지역 변수
...
//								= request.getRequestDispatcher("/views/msgShow.jsp");
		...
		request.setAttribute("msg", msg);  // msg는 위에 지역변수 , "msg"  jsp
		view.forward(request, response);  // 얘를 작성해야 작동함
		}
